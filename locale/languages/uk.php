...
$lang['uk'] += array(
	...
	'developers.peerunity_desc' => '<b>Peerunity</b> це програма-гаманець, яка розроблюється та підтримується спільнотою Peercoin. Вона включає в себе безліч додаткових функцій, які відсутні у офіційних гаманцях, такі як контроль та створення монет в один клік. Майбутні версії будуть містити перероблену тему, інтеграцію з Peershares та вкладку для створення монет.',
...
$lang['uk'] += array(
	...
	'mintguide.peerunity' => 'Peerunity - це клієнт, розроблений спільнотою Peercoin. Він має більше можливостей ніж стандартний клієнт Peercoin v0.4, а також має більш простий спосіб створення. Він доступний для Windows, Linux і OsX. Завантажити та переглянути випуски можна <a href="https://talk.peercoin.net/t/peerunity-v0-1-0-released-for-windows-linux-os-x/2455">тут</a>.',
	'mintguide.peerunity_step1' => 'Переконайтеся, що Ваш гаманець зашифрований надійною кодовою фразою. Запишіть її та зберігайте в безпеці; якщо Ви забудете кодову фразу, то Ви втратите свої монети. Опції щодо шифрування гаманця можна знайти у вкладці налаштувань в програмі Peerunity.',
	'mintguide.peerunity_step2' => 'Щоб почати створювати монети, просто натисніть кнопку «Відкрити гаманець тільки для створення монет», введіть ваш пароль і натисніть кнопку ОК.',
	'mintguide.peerunity_step3' => 'Ви можете перевірити, як проходить процес створення монет, глянувши на замок в нижньому правому куті клієнта. Через кілька секунд він повинен розблокуватися. Якщо ви наведете на нього курсор миші, повинно з\'явитися повідомлення «Гаманець зашифрований і в даний момент відкритий тільки для створення блоків».',
...
$lang['uk'] += array(
	...
	'wallet.desc' => 'Гаманець Peercoin - програмне забезпечення, що використовується для зберігання та проведення різних операцій з монетами Peercoins між користувачами. Peercoin має два гаманця для робочого столу: Peerunity і Peercoin-QT. Ми рекомендуємо Peerunity для більшості користувачів. Більше інформації про те, як користуватися програмним забезпеченням вашого гаманця, ви можете отримати відвідавши сторінку <a href="newcomers">Новичкам</a>.',
	'wallet.peerunity' => 'Peerunity (рекомендовано)',
	'wallet.peerunity_desc' => 'Peerunity створена співтовариством Peercoin. Вона включає функції, недоступні в основному протоколі, такі, як створення монет в один клік і контроль монет. Майбутні версії будуть містити перероблену контрольну панель, інтеграцію Peershares і спеціальну вкладку для створення монет.',
