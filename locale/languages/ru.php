...
$lang['ru'] += array(
	...
	'mintguide.peerunity' => 'Peerunity - клиент, разработанный сообществом Peercoin. Он имеет больше возможностей чем стандартный клиент Peercoin v0.4, а также имеет более простой способ чеканки. Он доступен для Windows, Linux и OS X. Загрузить и просмотреть выпуски можно <a href = "https://talk.peercoin.net/t/peerunity-v0-1-0-released-for-windows-linux-os-x/2455 ">здесь</a>.',
