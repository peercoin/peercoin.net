...
$lang['ru'] += array(
	...
	'developers.core_protocol_desc' => 'Будущие выпуски основного протокола кошелька содержат следующие функции:',
	'developers.cold_wallet_minting' => 'Создание монет с оффлайновым кошельком',
	'developers.cold_wallet_minting_desc' => 'В настоящее время, чтобы чеканить новые монеты, пользователи должны держать кошелёк подключенным к сети. Режим известен как <strong>горячий кошелёк</strong>. Горячие кошельки подвергаются большему риску и вредоносные программы могут украсть ваши монеты, потому что кошелёк должен оставаться подключенным к Интернету во время процесса чеканки. В следующих версиях Peercoin специальные <strong>ключи чеканки</strong> позволят пользователям чеканить монеты, сохраняя свои ключи расходов полностью вне сети.',
	'developers.optional_checkpointing' => 'Создание контрольных точек на свое усмотрение',
	'developers.optional_checkpointing_desc' => 'Сегодня сеть использует централизованную контрольную точку для защиты от атак. Потребность в этой безопасности уменьшается по мере роста сети, а в будущих версиях эти контрольные точки станут необязательными. В будущих версиях контрольные точки по умолчанию будут отключены.',
	'developers.peercoin_ecosystem' => 'Экосистема Peercoin ',
	'developers.peer4commit' => 'Хотели бы вы принять участие в разработке Peercoin <strong>и</strong> получать за это деньги? Вот ваш шанс! <a href="https://peer4commit.com">Peer4commit</a> предоставляет центральный хаб для разработки. Вы можете:',
	'developers.peer4commit.1' => 'Выберите проект на сайте, работайте над ним, и получайте за это монеты peercoin в качестве награды.',
	'developers.peer4commit.2' => 'Выберите проект, который вы хотели бы поддержать, и вкладывайте в него монеты peercoin.',
	...
	'developers.get_started' => 'Начало работы с Peer4commit',
	'developers.notable_community_projects' => 'Текущие проекты сообщества',
	'developers.peershares_desc' => '<b>Peershares</b> - это недорогая и децентрализованная бухгалтерская книга, которая будет использоваться в бизнесе для привлечения средств, отслеживания прав собственности на акции и распределении дивидендов в автоматическом режиме. Любой бизнес, использующий Peershares, будет иметь свою собственную, независимую от других цепочку блоков, которую можно дёшево и легко защитить с помощью метода proof-of-stake системы Peercoin.',
	'developers.peerbox_desc' => '<b>Peerbox</b> - это защищенная операционная система для создания монет и работы узлов Peercoin, которая сейчас находится на стадии активной разработки. Она фокусируется на недорогих, энергетически-эффективных устройствах, таких как Raspberry Pi, который совместим с целью Peercoin - обеспечивать энергоэффективную криптовалюту. Если ASIC - термин, описывающий специализированное и энергоэффективное создание монет, то Peerbox - это ASIC для метода Proof-of-Stake.',
	'developers.nubits_desc' => '<b>NuBits</b> - это проект от создателя Peershares, Джордана Ли. NuBits - это первая реализация Peershares. Она предназначена для решения проблемы волатильности криптовалют.',
	'developers.devforums' => 'Найдите другие инновационные идеи на наших <a href="https://talk.peercoin.net/c/projects">форумах</a> или присоединяйтесь к <a href="https://discord.gg/m294ReV">чату</a>, чтобы обсудить и поделиться своими.',
);
$lang['ru'] += array(
	//Exchanges
	'exchanges.what_are' => 'Что такое биржа?',
	'exchanges.what_are_desc' => '<b>Биржи</b> позволяют вам торговать официальными валютами, такими как доллар и евро, для того, чтобы покупать или продавать Peercoins. Биржи так же содействуют торговле между peercoins и другими криптовалютами, например, Bitcoin.',
	...
	'exchanges.fees_desc' => 'Каждый раз, когда происходит торг, небольшой процент забирается биржей за проведение транзакции. Это известно как <b>торговые комиссии</b>. Некоторые биржи взимают <b>комиссии за вывод средств</b> когда Вы выводите свою новую валюту с биржи. ',
	'exchanges.choosing' => '<b>Найдите обмен Peercoin с помощью <a href="http://coinmarketcap.com/currencies/peercoin/#markets">CoinMarketCap</a></b>.',
...
$lang['ru'] += array(
	...
	'footer.greenbar' => 'Чат с членами сообщества и разработчиками:',
);
$lang['ru'] += array(
	// FAQ
	'faq.yes' => 'Да',
	...
	'faq.q4_ans' => 'Peercoin несет в себе инновационные функции и возможности, имеет активных разработчиков и значительное участие сообщества. На 29 мая 2017 года Peercoin существует уже почти 5 лет и валюта имеет рыночную капитализацию более 37 миллионов долларов США. ',
	'faq.q5' => 'Является ли награда за создание монет в 1&#37; действующей для всех пользователей?',
	...
	'header.mint_peercoins' => 'Чеканка',
	'header.mining-guide' => 'Майнинг',
...
$lang['ru'] += array(
	...
	'index.total_supply' => 'Общий объём предложения ',
	...
	'index.why_peercoin_desc' => 'Peercoin стремится быть самой безопасной крипто-валютой с минимальными затратами, вознаграждая всех пользователей за укрепление сети, предоставляя им 1&#37; годового дохода за чеканку.',
	...
	'index.transparent_protocol' => 'Стабильный и <b>Безопасный</b>',
	'index.transparent_protocol_desc' => 'Защищает ваши инвестиции с 2012 года.',
	'index.energy_efficient' => '<b>Энергоэффективная</b>',
	...
	'index.investors_desc' => 'Награда в 1&#37; годовых при чеканке.',
...
$lang['ru'] += array(
	...
	'investors.established_network_desc' => 'Peercoin был запущен в 2012 году, что делает его одной из самых старых и самых надежных криптовалютных сетей в мире.',
	'investors.limited_supply' => 'Ограниченная поставка',
	'investors.limited_supply_desc' => 'Годовой уровень инфляции Peercoin в течение 2014 года составлял в среднем менее 5&#37;  и продолжает падать.',
	...
	'investors.guaranteed_returns_desc' => 'После того, как Peercoin удерживаются в течение 30 дней, они начинают зарабатывать годовое вознаграждение в размере 1&#37;. Читайте подробнее о <a href="minting">чеканке</a>. Также вы можете начинать покупать монеты с одного из многих <a href="exchanges">обменов Peercoin</a>.',
...
$lang['ru'] += array(
	...
	'mineguide.step1_desc' => 'Если вы еще не сделали этого, скачайте <a href="download">Кошелек Peercoin</a>.',
	...
	'mineguide.step3' => 'Зарегистрироваться на этом пуле',
	'mineguide.step3_desc' => 'Следуйте инструкциям на веб-сайте пула. Вы также можете найти больше пулов <a href="https://wiki.peercointalk.org/index.php?title=List_of_services#Mining_Pools">здесь</a>.',
);
$lang['ru'] += array(
	// Mining
	'mining.compatible_with_bitcoin' => 'Совместим с Bitcoin',
...
$lang['ru'] += array(
	...
	'minting.secure_the_network_desc' => 'Каждый раз, когда Вы создаёте монеты, появляется блок и Ваши монеты помогают защитить сеть. Чтобы атаковать сеть Peercoin, злоумышленник должен контролировать большинство процессов создания монет, что может в конечном счёте нанести вред его собственным инвестициям. ',
	'minting.earn_reward' => 'Заработай награду',
	'minting.earn_reward_desc' => 'Создание монет приносит Вам 1&#37; в год. Монеты могут быть созданы через 30 дней после того, как они были переданы, а после 90 дней шансы на успех будут максимальными. Если Вы создаёте монеты чаще, то Ваша прибыль увеличивается! ',

);$lang['ru'] += array(
	//Newcomers
	'newcomers.getting_started' => 'Начало работы с Peercoin',
	'newcomers.downlaod_wallet' => 'Скачать кошелёк',
	'newcomers.download_wallet_desc' => 'Пройдите на <a href="download">страницу загрузки</a>, где Вы можете найти программу для хранения и управления Вашими новыми монетами. ',
	...
	'pig.title' => 'Следуйте следующим шагам, чтобы принимать монеті Peercoins на своём сайте:',
	...
	'pig.step3' => 'Обеспечьте клиенту возможность оплатить покупки на Вашем сайте с помощью Peercoin. При выборе этой опции, отобразите один из адресов из базы данных, как платежный адрес для этого клиента, и сохраните его вместе с заказом. ',
	...
	'pig.step5' => 'Монеті Peercoin, отправленніе на импортированные адреса, защищены приватными ключами. Чтобы потратить их, используйте исходный файл кошелька, созданный в шаге 1. ',
	'pig.step6' => 'Если у вас возникнут какие-либо проблемы, не стесняйтесь публиковать их на <a href="https://talk.peercoin.net">форумах сообщества</a>.',
...
$lang['ru'] += array(
	...
	'wallet.desc' => 'Кошелек Peercoin - приложение, используемое для хранения и проведения различных операций с другими пользователями. Больше информации о том, как пользоваться программным обеспечением Вашего кошелька, Вы можете получить посетив  <a href="newcomers">Новичкам</a>.',
	'wallet.peercoinqt' => 'Peercoin-QT<br>(основной протокол)',
	'wallet.peercoinqt_desc' => 'Peercoin-QT - это основной протокол Peercoin, созданный и поддерживающийся разработчиком Peercoin Санни Кингом. Он получает обновления только с наивысшим приоритетом.',
	...
	'wallet.android_wallet_desc' => 'Мобильный кошелёк Peercoin, который позволяет Вам управлять Вашими монетами, без необходимости хранить полноразмерную цепочку блоков на Вашем мобильном телефоне. Это экономит драгоценное пространство на вашем андроид-устройстве и позволяет Вам брать монеты с собой, где бы Вы ни были. ',
	'wallet.download' => 'Скачать',
	'wallet.visit_site' => 'Посетите',
);
$lang['ru'] += array(
	//Whitepaper
