...
$lang['ru'] += array(
	...
	'developers.cold_wallet_minting_desc' => 'В настоящее время, чтобы чеканить новые монеты, пользователи должны держать кошелек подключенным к сети. Режим известен как <strong>горячий кошелек</strong>. Горячие кошельки подвергаются большему риску и вредоносные программы могут украсть ваши монеты, потому что кошелек должны оставаться подключенными к Интернету во время процесса чеканки. В следующих версиях Peercoin специальные <strong>ключи чеканки</strong> позволят пользователям чеканить, сохраняя свои ключи расходов полностью автономно.',
	...
	'developers.peer4commit' => 'Хотели бы вы принять участие в разработке Peercoin <strong>и</strong> получить за это деньги? Вот ваш шанс! <a href="https://peer4commit.com">Peer4commit</a> предоставляет центральный хаб для разработки. Вы можете:',
	...
	'developers.nubits_desc' => '<b>NuBits</b> - это проект от создателя Peershares, Jordan Lee. NuBits - это первая реализация Peershares. Он предназначен для решения проблемы волатильности криптовалют.',
	'developers.devforums' => 'Найдите другие инновационные идеи на наших <a href="https://talk.peercoin.net/c/projects">форумах</a>, или присоединяйтесь к <a href="https://peercoin.chat">чату</a>, чтобы обсудить и поделиться своими идеями.',
);
$lang['ru'] += array(
	//Exchanges
