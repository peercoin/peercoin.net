    ...
    <>
      ...
      <div className="PrivacyPage main text-sections">
        <div className="container">
          ...
          <h2>Links</h2>
          <p>Peercoin.net contains links to external sites. Peercoin is not responsible for the content, experience, security, or privacy practices of these sites. We encourage users to be aware when they leave the site and to read the external website's privacy statements that may collect personal user data.</p>
          ...
          <p>When you use and access the Service, we may place a number of cookies files in your web browser. We use cookies for the following purposes: to enable certain functions of the Service, to provide analytics, and to store your preferences. We use both session and persistent cookies on the Service and we use different types of cookies to run the Service:</p>
          ...
          <p>From time to time, we may update our Privacy Policy. You will not be notified. As such, we encourage you to periodically review these policies for the latest information on practices.</p>
        </div>
      </div>
      <Footer />
    </>
